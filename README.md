...
[![codecov](https://codecov.io/gh/kaasun/fastapi/branch/main/graph/badge.svg?token=fastapi_token_here)](https://codecov.io/gh/kaasun/fastapi)
[![CI](https://github.com/kaasun/fastapi/actions/workflows/main.yml/badge.svg)](https://github.com/kaasun/fastapi/actions/workflows/main.yml)

Awesome fastapi created by kaasun

## Install

from source
```bash
git clone https://github.com/kaasun/fastapi fastapi
cd fastapi
make install
```
